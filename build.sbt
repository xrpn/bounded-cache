...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/alsq/bounded-cache"),
        "git@github.com:alsq/bounded-cache.git"
      )
    ),
    homepage := Some(url("https://github.com/alsq/bounded-cache")),
